...
#### Usage
Use GET to retrieve business insights data for a GMAID, that comes from the Premium Listing Reporting API and will be filtered by a specific date range determined by start date and end date.
...
```
curl -L -X GET 'https://data-connect-prod.gannettdigital.com/premium_listings/business/GMAID/insights' \
