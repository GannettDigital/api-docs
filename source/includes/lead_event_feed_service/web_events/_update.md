...
url = URI("https://api.reachlocalservices.com/leads/web_events/123.json")
...
Request request = new Request.Builder()
  .url("https://api.reachlocalservices.com/leads/web_events/123.json")
  .put(body)
...
```shell
curl -X PUT \
  https://api.reachlocalservices.com/leads/web_events/123.json \
