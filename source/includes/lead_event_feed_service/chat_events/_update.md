...
url = URI("https://api.localiqservices.com/leads/chat_events/123.json")
...
Request request = new Request.Builder()
  .url("https://api.localiqservices.com/leads/chat_events/123.json")
  .put(body)
...
```shell
curl -X PUT \
  https://api.localiqservices.com/leads/chat_events/123.json \
