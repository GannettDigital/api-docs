...
|---|---|---|
|Identity|[Identity](#identity_api)|The identity endpoint is used to gain insight into the advertisers that the user is authorized to retrieve data from, active state of the advertiser and if user has the privileges to retrieve HIPAA protected data through the API.|
