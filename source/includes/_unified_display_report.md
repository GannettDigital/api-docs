...
|`universal_interaction_rate`|Float|No|Overall Universal Interaction Rate for Line Item|
|`universal_interaction_time`|Float|No|Overall Universal Interaction Time for Line Item|
|`hover_rate`|Float|No|Hover Rate for Line Item|
|`attention_quality`|Float|No|Attention Quality for Line Item|
...
|`universal_interaction_rate`|Float|No|Overall Universal Interaction Rate for Interval|
|`universal_interaction_time`|Float|No|Overall Universal Interaction Time for Interval|
|`hover_rate`|Float|No|Hover Rate for Interval|
|`attention_quality`|Float|No|Attention Quality for Interval|
|`video_full_screen`|Float|Yes|Number of Full-Screen Video Views|
|`video_mute`|Float|Yes|Number of Muted Video Views|
|`video_unmute`|Float|Yes|Number of Unmuted Video Views|
|`video_pause`|Float|Yes|Number of Paused Video Views|
...
|`universal_interaction_rate`|Float|No|Overall Universal Interaction Rate for Creative|
|`universal_interaction_time`|Float|No|Overall Universal Interaction Time for Creative|
|`hover_rate`|Float|No|Hover Rate for Creative|
|`attention_quality`|Float|No|Attention Quality for Creative|
|`video_full_screen`|Float|Yes|Number of Full-Screen Video Views|
|`video_mute`|Float|Yes|Number of Muted Video Views|
|`video_unmute`|Float|Yes|Number of Unmuted Video Views|
|`video_pause`|Float|Yes|Number of Paused Video Views|
