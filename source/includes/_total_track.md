...
https://api.reachlocalservices.com/api/client_reports/total_track/USA_105569?start_date=2016-12-01&end_date=2016-12-31
```
...
https://api.reachlocalservices.com/api/client_reports/total_track/USA_105569?global_master_campaign_id[]=USA_14&start_date=2016-10-01&end_date=2016-12-31
```
...
```
curl -H "Authorization: OAUTH_ACCESS_TOKEN" \
https://api.reachlocalservices.com/api/client_reports/total_track/USA_105569?campaign_cycle=USA_100
```
...
```
curl -g -H "Authorization: OAUTH_ACCESS_TOKEN" \
https://api.reachlocalservices.com/api/client_reports/total_track/USA_105569?&campaign_status[]=running&campaign_status[]=stopped&start_date=2016-10-01&end_date=2016-12-31
```
...
```
curl -g -H "Authorization: OAUTH_ACCESS_TOKEN" \
https://api.reachlocalservices.com/api/client_reports/total_track/USA_105569?global_master_campaign_id[]=USA_14&start_date=2016-10-01&end_date=2016-12-31&include_cycles=true
```
...
```javascript
{
  ...
  "location": "https://api.reachlocalservices.com/api/client_reports/total_track/USA_105569?campaign_cycle=45&global_master_campaign_id=USA_14&range=cycle",
...
```json
{
  ...
  "location": "https://api.reachlocalservices.com/api/client_reports/total_track/USA_123?start_date=2016-12-01&end_date=2016-12-31",
  "available_campaigns": [
    {
      "name": "TotalTrack Campaign",
      "global_master_campaign_id": "USA_5",
