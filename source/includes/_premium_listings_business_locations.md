...
| Method | URI Format |
|---|---|
| GET | /client_reports/premium_listings_business/[gmaid]/locations?[query_params]
...
```
curl -L -X GET 'https://api.gcion.com/apgb2b-reporting/client_reports/premium_listings_business/GMAID/locations' \
