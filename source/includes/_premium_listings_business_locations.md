...
#### Usage
Use GET to retrieve business locations data, that comes from the Premium Listing Reporting API and will be returned for a GMAID by a specific date range determined by start date and end date.
...
```
curl -L -X GET 'https://data-connect-prod.gannettdigital.com/premium_listings/business/GMAID/locations' \
